          ...
          <div className="border-l-[2px] border-neutral-800 ps-4 lg:ps-10 space-y-10">
            ...
            <div>
              <div className="flex flex-col lg:flex-row gap-x-10 bg-black p-10 rounded-xl space-y-4 lg:items-center">
                <div className="child relative group-hover:scale(1.2) w-[250px] h-[175px]  md:w-[300px] md:h-[200px] lg:w-[400px] lg:h-[300px] 2xl:w-[500px] 2xl:h-[400px]   rounded-2xl overflow-hidden">
                  <Image
